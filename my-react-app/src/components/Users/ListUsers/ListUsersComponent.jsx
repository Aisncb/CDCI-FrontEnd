...
function ListUsersComponent(props) {
  ...
  const dataColumns = ["Id","Nombre", "Apellido", "Fecha Nacimiento", "Direccion", "Telefono", "Correo Electronico", "DNI", "Rol"] // crea los campos que tendrá la cabecera manualmente
              ...
              .map((user) => {
                return (
                  <TableRow hover role="checkbox" tabIndex={-1} key={user.id}>
                    ...
                    <TableCell >{user.fechaNacimiento.substr(0,10)}</TableCell>
